...
!function (t, e) {
        ...
        return function (t) {
            ...
            if (t) 
                return "string" == typeof t
                    ? a(t, e)
                    : "Map" === (
                        i = "Object" === (i = Object.prototype.toString.call(t).slice(8, -1)) && t.constructor
                            ? t.constructor.name
                            : i
                    ) || "Set" === i
                        ? Array.from(t)
    ...
    var kt,
        Ot,
        Tt = /\s\s*/,
        Et = (Ot = !1, t && (kt = !1, i = function () {}, e = Object.defineProperty(
            {},
            "once",
            {
                get: function () {
    ...
    function s(i, t, a, e) {
        var n = 3 < arguments.length && void 0 !== e
                ? e
                : {},
            o = a;
        t
    ...
    function b(o, t, h, e) {
        var r = 3 < arguments.length && void 0 !== e
                ? e
                : {},
            s = h;
        t
    ...
    function Rt(t) {
        ...
        try {
            ...
            if (
                a = i && (n = i + 10, "Exif" === function (t, e, i) {
                    var a = "";
                    i += e;
                    for (var n = e; n < i; n += 1) 
                        a += Yt(t.getUint8(n));
                    return a
                }(s, i + 4, 4)) && ((r = 18761 === (o = s.getUint16(n))) || 19789 === o) && 42 === s.getUint16(
                    n + 2,
                    r
    ...
    var t = {
            ...
            limitCanvas: function (t, e) {
                ...
                t && (
                    ...
                    1 < h
                        ? (t = Math.max(t, a.width), i = Math.max(i, a.height), 3 === h && (
                            t < i * r
                                ? t = i * r
                                : i = t / r
                        ))
            ...
            initPreview: function () {
                ...
                e && (
                    ...
                    z(this.previews = o, function (t) {
                        ...
                        e.src = a,
                        e.alt = n,
                        e.style.cssText = 'display:block;width:100%;height:auto;min-width:0!important;min-height:0!import' +
                                'ant;max-width:none!important;max-height:none!important;image-orientation:0deg!' +
                                'important;"',
                        t.innerHTML = "",
                        t.appendChild(e)
                    })
        ...
        St = {
            resize: function () {
                ...
                this.disabled || (
                    ...
                    1 != (
                        ...
                        this.setCanvasData(z(o, function (t, e) {
                            o[e] = t * n
                        })),
            ...
            dblclick: function () {
                var t,
                    e;
                this.disabled || this.options.dragMode === _ || this.setDragMode((
                    t = this.dragBox,
                    e = Q,
                    (
                            t.classList
            ...
            wheel: function (t) {
                var e = this,
                    ...
                    a = 1;
                this.disabled || (t.preventDefault(), this.wheeling) || (
                    this.wheeling = !0,
                    setTimeout(function () {
                        e.wheeling = !1
                    }, 50),
            ...
            cropStart: function (t) {
                ...
                this.disabled || (
                    ...
                    t.changedTouches
                        ...
                        : e[t.pointerId || 0] = M(t),
                    a = 1 < Object.keys(e).length && i.zoomable && i.zoomOnTouch
                        ? $
                        : Bt(t.target, d),
        ...
        At = {
                ...
                return !this.disabled && e && (
                    ...
                    t
                        ? (
                            this.url = e,
                            this.image.src = e,
                            this.ready && (this.viewBoxImage.src = e, z(this.previews, function (t) {
                                t
            ...
            enable: function () {
                return this.ready && this.disabled && (this.disabled = !1, X(this.cropper, K)),
                this
            },
            disable: function () {
                return this.ready && !this.disabled && (this.disabled = !0, v(this.cropper, K)),
                this
            },
            destroy: function () {
                var t = this.element;
            ...
            moveTo: function (t) {
                ...
                return t = Number(t),
                e = Number(e),
                this.ready && !this.disabled && this.options.movable && (
                    p(t) && (i.left = t, a = !0),
                    p(e) && (i.top = e, a = !0),
                    a
                ) && this.renderCanvas(!0),
            ...
            rotateTo: function (t) {
                return p(t = Number(t)) && this.ready && !this.disabled && this.options.rotatable && (
            ...
            scale: function (t) {
                ...
                return t = Number(t),
                e = Number(e),
                this.ready && !this.disabled && this.options.scalable && (
                    p(t) && (i.scaleX = t, a = !0),
                    p(e) && (i.scaleY = e, a = !0),
                    a
                ) && this.renderCanvas(!0, !0),
            ...
            setData: function (t) {
                var e,
                    ...
                    n = this.canvasData,
                    o = {};
                return this.ready && !this.disabled && u(t) && (
                    e = !1,
                    i.rotatable && p(t.rotate) && t.rotate !== a.rotate && (a.rotate = t.rotate, e = !0),
                    i.scalable && (p(t.scaleX) && t.scaleX !== a.scaleX && (a.scaleX = t.scaleX, e = !0), p(t.scaleY)) && t.scaleY !== a.scaleY && (a.scaleY = t.scaleY, e = !0),
            ...
            setCropBoxData: function (t) {
                ...
                return this.ready && this.cropped && !this.disabled && u(t) && (
            ...
            getCroppedCanvas: function () {
                var t,
                    ...
                    B,
                    k,
                    O = 0 < arguments.length && void 0 !== arguments[0]
                        ? arguments[0]
                        : {};
                return this.ready && window.HTMLCanvasElement
                    ? (
                        ...
                        r = a.naturalWidth,
                        a = a.naturalHeight,
                        h = void 0 === (h = v.fillColor)
                            ? "transparent"
                            : h,
                        p = void 0 === (p = v.imageSmoothingEnabled) || p,
                        m = void 0 === (m = v.imageSmoothingQuality)
                            ? "low"
                            : m,
                        o = void 0 === (o = v.maxWidth)
                            ? 1 / 0
                            : o,
                        k = void 0 === (k = v.maxHeight)
                            ? 1 / 0
                            : k,
                        t = void 0 === (t = v.minWidth)
                            ? 0
                            : t,
                        v = void 0 === (v = v.minHeight)
                            ? 0
                            : v,
            ...
            (e = [
                {
                    ...
                    value: function () {
                        var t,
                            ...
                            r,
                            s;
                        this.sized && !this.ready && (
                            t = this.element,
                            e = this.options,
                            i = this.image,
                            a = t.parentNode,
                            (n = document.createElement("div")).innerHTML = '<div class="cropper-container" touch-action="none"><div class="cropper-wrap-bo' +
                                    'x"><div class="cropper-canvas"></div></div><div class="cropper-drag-box"></div' +
                                    '><div class="cropper-crop-box"><span class="cropper-view-box"></span><span cla' +
                                    'ss="cropper-dashed dashed-h"></span><span class="cropper-dashed dashed-v"></sp' +
                                    'an><span class="cropper-center"></span><span class="cropper-face"></span><span' +
                                    ' class="cropper-line line-e" data-cropper-action="e"></span><span class="cropp' +
                                    'er-line line-n" data-cropper-action="n"></span><span class="cropper-line line-' +
                                    'w" data-cropper-action="w"></span><span class="cropper-line line-s" data-cropp' +
                                    'er-action="s"></span><span class="cropper-point point-e" data-cropper-action="' +
                                    'e"></span><span class="cropper-point point-n" data-cropper-action="n"></span><' +
                                    'span class="cropper-point point-w" data-cropper-action="w"></span><span class=' +
                                    '"cropper-point point-s" data-cropper-action="s"></span><span class="cropper-po' +
                                    'int point-ne" data-cropper-action="ne"></span><span class="cropper-point point' +
                                    '-nw" data-cropper-action="nw"></span><span class="cropper-point point-sw" data' +
                                    '-cropper-action="sw"></span><span class="cropper-point point-se" data-cropper-' +
                                    'action="se"></span></div></div>',
